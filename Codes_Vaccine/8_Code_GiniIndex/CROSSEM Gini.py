...
author_df = pd.read_csv('/Users/garima/Desktop/Self/PhD/Research Work/Fairness in Summarization/Codes_Vaccine/Original_30_Vaccine_Clean.csv', engine='python')
...
for asl in algo_summ_list :
    ...
    algo_df = pd.read_csv('/Users/garima/Desktop/Self/PhD/Research Work/Fairness in Summarization/Codes_Vaccine/Data_Algo_Summary_10/' + asl + '.txt', sep = "\n\n", header=None, engine='python')
