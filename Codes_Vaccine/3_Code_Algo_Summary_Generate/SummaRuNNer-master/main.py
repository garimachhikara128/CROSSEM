...
parser.add_argument('-embedding',type=str,default='/Users/garima/Desktop/Self/PhD/Research Work/Fairness in Summarization/Codes_Vaccine/3_Code_Algo_Summary_Generate/SummaRuNNer-master/data/embedding.npz')
parser.add_argument('-word2id',type=str,default='/Users/garima/Desktop/Self/PhD/Research Work/Fairness in Summarization/Codes_Vaccine/3_Code_Algo_Summary_Generate/SummaRuNNer-master/data/word2id.json')
parser.add_argument('-report_every',type=int,default=1500)
parser.add_argument('-seq_trunc',type=int,default=50)
parser.add_argument('-max_norm',type=float,default=1.0)
# test
parser.add_argument('-load_dir',type=str,default='/Users/garima/Desktop/Self/PhD/Research Work/Fairness in Summarization/Codes_Vaccine/3_Code_Algo_Summary_Generate/SummaRuNNer-master/checkpoints/RNN_RNN_seed_1.pt')
...
SAVING =  '/Users/garima/Desktop/Self/PhD/Research Work/Fairness in Summarization/Codes_Vaccine/Data_Algo_Summary_12/'
...
def predict(examples):
    ...
    for batch in tqdm(pred_iter):
        ...
        for doc_id,doc_len in enumerate(doc_lens):
            ...
            hyp = [doc[index] for index in topk_indices]
            with open(SAVING + 'RNN_RNN.txt', 'w') as f:
                f.write('\n\n'.join(hyp))
            start = stop
            file_id = file_id + 1
    print('Speed: %.2f docs / s' % (doc_num / time_cost))
...
if __name__=='__main__':
    ...
    filename = '/Users/garima/Desktop/Self/PhD/Research Work/Fairness in Summarization/Codes_Vaccine/Original_30_CovidVaccine_Clean.txt'
